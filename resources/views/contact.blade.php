...
<head>
    <title>فروش گاه زی - تماس با ما</title>
    <meta charset="utf-8">
...
<div class="container-fluid bg-light py-5">
    <div class="col-md-6 m-auto text-center">
        <h1 class="h1">با ما تماس بگیرید</h1>
        <p>
        ...
        <form class="col-md-9 m-auto" method="post" role="form">
            <div class="row">
                <div class="form-group col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control mt-1" id="name" name="name" placeholder="نام">
                </div>
                <div class="form-group col-md-6 mb-3">
                    <label for="inputemail">ایمیل</label>
                    <input type="text" class="form-control mt-1" id="email" name="email" placeholder="ایمیل">
                </div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control mt-1" id="message" name="message" placeholder="پیام" rows="8"></textarea>
            </div>
            <div class="row">
