...
<head>
    <title>فروشگاه زی - درباره ما</title>
    <meta charset="utf-8">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-3 pb-5">
            <div class="h-100 py-5 services-icon-wap shadow">
                ...
                <h2 class="h5 mt-4 text-center">خدمات حمل ونقل</h2>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 pb-5">
            <div class="h-100 py-5 services-icon-wap shadow">
                ...
                <h2 class="h5 mt-4 text-center">حمل و نقل و برگشت</h2>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 pb-5">
            <div class="h-100 py-5 services-icon-wap shadow">
                ...
                <h2 class="h5 mt-4 text-center">ترویج</h2>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 pb-5">
            <div class="h-100 py-5 services-icon-wap shadow">
                ...
                <h2 class="h5 mt-4 text-center">خدمات 24 ساعته</h2>
            </div>
        </div>
    </div>
</section>
